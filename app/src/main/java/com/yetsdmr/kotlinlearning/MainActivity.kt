package com.yetsdmr.kotlinlearning
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val myString = "yetsdmr"
        val name = "Yunus Emre"
        val surname = "Taşdemir"
        ...
        val myArray = arrayOf("Emre","Onur","Ali","Baybar")

        //index
        println(myArray[0])
        myArray[0] = "Emre Taşdemir"
        println(myArray[0])

        myArray.set(1,"Onur Kızaldaş")
        ...
        val myMusician = arrayListOf<String>("Emre","Onur")
        myMusician.add("Ali")
        println(myMusician[2])
        myMusician.add(0,"Pepe")
        ...
        myStringArrayList.add("Emre")
        myStringArrayList.add("Taşdemir")
        myStringArrayList.add("Pepe")
